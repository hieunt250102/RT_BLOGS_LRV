                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a class="count-indicator btn btn-sm btn-warning btn-icon" href="#" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-pen-to-square"></i></a>
                                ...
                                <a href="" class="btn btn-sm btn-danger btn-icon"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
