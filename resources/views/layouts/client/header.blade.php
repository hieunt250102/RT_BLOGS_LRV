                ...
                <div class="nav__option">
                    ...
                    <div class="nav__option--user dropdown">
                        <!-- <div class="dropdown-content">
                            <a href="#">{{ trans('header-client.btn-logout') }}</a>
                            <a href="#">{{ trans('header-client.btn-my-blogs') }}</a>
                        </div>
                        <p class="nav__option--user-name">My name</p> -->
                        <a href="/sign-in" class="nav__option--user-name">{{ trans('header-client.btn-signin') }}</a>
                        <a href="/sign-up" class="nav__option--user-name">{{ trans('header-client.btn-signup') }}</a>
